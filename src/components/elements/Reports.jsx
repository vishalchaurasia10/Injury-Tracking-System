...
const Reports = () => {
    const { getReports, reportData, deleteReport, loading } = useContext(reportContext)
        ...
        <div>
            {loading ?
                <div className='h-screen w-full flex flex-col space-y-2 items-center justify-center'>
                    ...
                    <span className={`${jost.className} text-xl`}>Loading</span>
                </div>
                :
                                    ...
                                    return (
                                        <>
                                            <div key={index} className="card lg:mx-2 mb-4 w-full lg:w-96 bg-base-100 shadow-xl">
                                                ...
                                                <FaTrashAlt title='Delete' onClick={() => handleDeleteReport(report.$id)} className='absolute right-3 top-3 rounded-lg bg-black p-2 text-4xl text-red-500 cursor-pointer transition-all duration-300 hover:scale-110 hover:bg-white hover:shadow-2xl hover:shadow-black' />
                                                ...
                                                <div className="modal-box">
                                                    ...
                                                    <div className="modal-action">
                                                        <form className='space-x-2' method="dialog">
                                                            <button onClick={() => { deleteReport(deleteId); setDeleteId('') }} className="btn btn-neutral">Delete</button>
